...
namespace RustPlusApi
{
    ...
    public class RustPlus : IDisposable
    {
        ...
        public bool UseFacepunchProxy = false;

        /// <summary>
        /// Send server and other info etc.
        /// </summary>
        public void SendConnectionInfo(string server, int port, ulong playerId, int playerToken, bool useFacepunchProxy)
        {
            Server = server;
            Port = port;
            PlayerId = playerId;
